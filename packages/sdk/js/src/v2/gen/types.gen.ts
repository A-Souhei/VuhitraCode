...
export type IndexerDeleteDataData = {
  body?: never
  path?: never
  query?: {
    directory?: string
...
export type IndexerDeleteDataErrors = {
  /**
   * Confirmation header missing or invalid (requires X-Confirm-Deletion: true)
   */
  400: unknown
}

export type IndexerDeleteDataResponses = {
  /**
   * Index data successfully deleted
   */
  204: void
}
